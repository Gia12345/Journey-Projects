...
from data_clean import replace_null_values, get_categorical_data, get_numerical_data
...
categorical_data = get_categorical_data(train_x)
numerical_data = get_numerical_data(train_x)

#Replace null values in both categorical data nd numerical_data
