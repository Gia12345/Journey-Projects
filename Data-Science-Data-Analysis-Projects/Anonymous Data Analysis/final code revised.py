...
train_categorical_data = train_x.select_dtypes(exclude='float')
train_numerical_data = train_x.select_dtypes(include='float')
test_categorical_data = test_x.select_dtypes(exclude='float')
test_numerical_data = test_x.select_dtypes(include='float')
...
#Fix inconsistancies in categorical data
train_categorical_data = parse_categorical_data(train_categorical_data)
test_categorical_data = parse_categorical_data(test_categorical_data)
